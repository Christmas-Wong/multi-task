'''
Author: your name
Date: 2021-09-29 16:59:08
LastEditTime: 2021-10-09 15:47:25
LastEditors: Please set LastEditors
Description: In User Settings Edit
FilePath: /classification_base_project/src/args/arg_input.py
'''
# -*- coding: utf-8 -*-
"""
@Time    : 2021/9/18 2:30 下午
@Author  : Fei Wang
@File    : model_args
@Software: PyCharm
@Description: 
...
class DataTrainingArguments:
    ...
    r_drop: bool = field(
        default=False, metadata={"help": "Whether  to use R_Drop trainer."}
    )
